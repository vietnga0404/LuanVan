                            ...
                            <div class="row" style="border-bottom: 2px dotted #ddd;margin-bottom:10px">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select required id="" name="lop" style="width: 80%;padding:10px">
                                            <option value=""></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required id="" name="mon" style="width: 80%;padding:10px">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" id="" name="tungay" style="width: 50%;padding:10px">

                                    </div>
                                    <div class="form-group">
                                        <label for="">Đến ngày:</label>
                                        <input required type="date" id="date" name="denngay" style="width: 50%;padding:10px">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Địa điểm:</label>
                                        <input required type="text" name="diadiem" style="width: 35%;padding:10px">
                                    </div>
                                </div>
                            </div>
