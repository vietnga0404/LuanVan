        ...
        <div class="row">
            <form action="" method="get" style="margin-bottom: 20px;margin-left:17px" autocomplete="off">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="khoa" class="form-control" placeholder="Khóa học tìm kiếm.. " value="{{request()->khoa}}">
                    </div>
                    <div class="col-md-4">
...
<div class="p-t-100 p-b-140" style="background-color: #F8F0E5;">
    <div class="container">
        @include('errors.note')
        <div class="row">
                ...
                <div class="panel ">
                    ...
                    <div class="panel-body">
                        <div class="bootstrap-table">
                            <table class="table table-bordered" style="margin-top:20px;text-align:center;margin-bottom:0px">
                                <thead>
                                    <tr class="bg-primary">
                                        <th>Khóa học</th>
                                        <th>Hình thức lớp</th>
                            ...
                            <div class="card-footer py-4 page-link" style="text-align:right;">
                                <nav aria-label="...">
                                    <ul class="pagination justify-content-start" style="margin: 0px 0px;">
                                        {{$listlop->links("pagination::bootstrap-4")}}
                                    </ul>
                                </nav>
                            </div>
                        </div>
                            ...
                            <form method="post" enctype="multipart/form-data" autocomplete="off">
                                <div class="row" style="padding: 25px;">
                                    ...
                                    <div class="form-group">
                                        <label>Khóa học <a href="#" style="color: red;">*</a></label>
                                        <input required type="text" name="khoa" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Hình thức lớp <a href="#" style="color: red;">*</a></label>
                                        <select required name="hinhthuc" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label>Mã lớp <a href="#" style="color: red;">*</a></label>
                                        <input required type="text" name="ma" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Tên lớp <a href="#" style="color: red;">*</a></label>
