...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <ul class="nav menu">
            ...
            <li>
                <a href="{{asset('admin/khoa')}}">
                    <i class="glyph fa fa-tasks" aria-hidden="true"></i>Quản lý Khoa
                </a>
            </li>
            <li>
                <a href="{{asset('admin/lop')}}">
                    <i class="glyph fa fa-university" aria-hidden="true"></i>Quản lý Lớp học
                </a>
            </li>
            <li>
                <a href="{{asset('admin/mon')}}">
                    <i class="glyph fa fa-book" aria-hidden="true"></i>Quản lý Môn học
                </a>
            </li>
            <li>
                <a href="{{asset('admin/phancong')}}">
                    <i class="glyph fa fa-calendar" aria-hidden="true"></i>Phân công Giảng dạy
                </a>
            </li>
            <li>
                <a href="{{asset('admin/')}}">
                    <i class="glyph fa fa-id-card" aria-hidden="true"></i>Quản lý Tài khoản
                </a>
            </li>
        </ul>
    </div><!--/.sidebar-->
